    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="py-3">
          ...
          {user ? (
            <DialogDescription>
              Would you like to add this movie to your watch history? This will personalize your future recommendations.
            </DialogDescription>
          ) : (
            <div className="px-4 py-3 bg-primary/5 rounded-md text-sm">
              <p className="font-medium mb-1">Sign in to track your watch history</p>
              <p className="text-muted-foreground mb-3">
                Create an account to keep track of what you've watched and get personalized recommendations.
              </p>
              <Link href="/auth">
